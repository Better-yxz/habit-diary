...
import { Plus, Clock, Calendar, Sparkles, Settings, User, X } from 'lucide-react';
    ...
    <div className="min-h-screen" style={{ background }}>
      <div className="min-h-screen bg-white/40 backdrop-blur-[1px]">
            ...
            <div className="flex items-center gap-4">
              {currentUser ? (
                <Link href="/settings" className="flex items-center gap-2 px-4 py-2 text-[#64748b] hover:text-[#0f172a] transition-colors">
                  <User size={18} /> {currentUser.username || currentUser.email.split('@')[0]}
                </Link>
              ) : (
        ...
        <div className="max-w-5xl mx-auto px-6 py-8">
          ...
          <div className="mb-8">
            <h3 className="text-lg font-medium text-[#0f172a] mb-4">快速记录</h3>
